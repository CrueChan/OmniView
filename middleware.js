import { sha256 } from './js/sha256.js'; // Need to create or import SHA-256 implementation
...
export default async function middleware(request) {
  ...
  if (adminpassword) {
    adminpasswordHash = await sha256(adminpassword); // Fix variable name
  }
  
  // Merge two replacements into one operation
